    ...
    public partial class Form1 : Form
    {
        ...
        private static void taskX()
        {
            while (running)
            {
                ...
                if (wu[4] == 1)
                    controller.Buttons &= ~X360Buttons.Up;
                valchanged(5, LeftButtonSL | LeftButtonSR | LeftButtonMINUS | acc_gLeftY <= -1.13);
                if (wd[5] == 1)
                ...
                if (wu[10] == 1)
                    controller.Buttons &= ~X360Buttons.X;
                valchanged(11, mWSButtonStatePlus | mWSButtonStateUp);
                if (wd[11] == 1)
                    controller.Buttons ^= X360Buttons.RightBumper;
                if (wu[11] == 1)
                    controller.Buttons &= ~X360Buttons.RightBumper;
                valchanged(12, mWSButtonStateMinus | mWSButtonStateUp);
                if (wd[12] == 1)
                ...
                if (wu[13] == 1)
                    controller.Buttons &= ~X360Buttons.B;
                valchanged(14, mWSButtonStateLeft | mWSButtonStateRight);
                if (wd[14] == 1)
