...
namespace WiiJoyKM
{
    public partial class Form1 : Form
    {
        ...
        public static string KeyboardMouseDriverType;
        public static double MouseMoveX, MouseMoveY, MouseAbsX, MouseAbsY, MouseDesktopX, MouseDesktopY;
        public static int WidthS = Screen.PrimaryScreen.Bounds.Width / 2;
        public static int HeightS = Screen.PrimaryScreen.Bounds.Height / 2;
        ...
        private static void taskX()
        {
            while (running)
            {
                ...
                if (Getstate)
                {
                    ...
                    MouseDesktopX = WidthS - mousex * WidthS / 1024f;
                    MouseDesktopY = HeightS + mousey * HeightS / 1024f;
                    Send1 = LeftButtonDPAD_UP;
                    Send2 = LeftButtonDPAD_LEFT;
                    Send3 = LeftButtonDPAD_DOWN;
                    Send4 = LeftButtonDPAD_RIGHT;
                    Send5 = LeftButtonMINUS;
                    SendA = LeftButtonSL;
                    SendE = LeftButtonSR;
                    SendLeftControl = LeftButtonSTICK;
                    SendSpace = LeftButtonSHOULDER_1;
                    SendLeftShift = LeftButtonSHOULDER_2 | LeftButtonSTICK;
                    SendD = StickLeftX > 0.35f;
                    SendQ = StickLeftX < -0.35f;
                    SendZ = StickLeftY > 0.35f;
                    SendS = StickLeftY < -0.35f;
                    SendV = acc_gLeft.Y <= -1.13;
                    ...
                    SendY = mWSButtonStateLeft;
                    SendU = mWSButtonStateRight;
        ...
        private static void ProcessButtonsAndStickLeft()
        {
            ...
            StickLeftX = stickLeft[0] + (stickLeft[0] >= 0 ? (stickLeft[0] >= 0 ? stickLeft[0] : -stickLeft[0]) * (stickLeft[1] >= 0 ? stickLeft[1] : -stickLeft[1]) : -(stickLeft[0] >= 0 ? stickLeft[0] : -stickLeft[0]) * (stickLeft[1] >= 0 ? stickLeft[1] : -stickLeft[1])) * 1.1f;
            StickLeftY = stickLeft[1] + (stickLeft[1] >= 0 ? (stickLeft[1] >= 0 ? stickLeft[1] : -stickLeft[1]) * (stickLeft[0] >= 0 ? stickLeft[0] : -stickLeft[0]) : -(stickLeft[1] >= 0 ? stickLeft[1] : -stickLeft[1]) * (stickLeft[1] >= 0 ? stickLeft[1] : -stickLeft[1])) * 1.1f;
        }
