    ...
    public partial class Form1 : Form
    {
        ...
        private static void taskX()
        {
            while (running)
            {
                ...
                leftstick = LeftButtonSL | LeftButtonSR | LeftButtonMINUS;
                rightstick = LeftButtonSHOULDER_2;
                ...
                leftbumper = mWSButtonStateMinus | mWSButtonStateLeft;
                rightbumper = mWSButtonStatePlus | mWSButtonStateRight;
                B = mWSButtonStateDown;
                Y = acc_gLeft.Y <= -1.13 | mWSButtonStateUp;
