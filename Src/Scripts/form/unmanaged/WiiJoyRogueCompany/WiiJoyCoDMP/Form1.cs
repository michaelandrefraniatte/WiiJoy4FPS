    ...
    public partial class Form1 : Form
    {
        ...
        private void taskX()
        {
            while (running)
            {
                ...
                start = mWSButtonStateTwo | Joystick1Buttons13;
                A = Joystick1Buttons14;
                B = mWSButtonStateDown;
                Y = mWSButtonStateRight | mWSButtonStateLeft;
