        ...
        private static void taskX()
        {
            while (running)
            {
                ...
                if (Getstate)
                {
                    ...
                    MouseAbsX = 32767.5 - mousex * 32767.5 / 2048f;
                    MouseAbsY = 32767.5 + mousey * 32767.5 / 2048f;
                    ...
                    SendEscape = mWSButtonStateTwo | LeftButtonCAPTURE;
                    ...
                    SendT = mWSButtonStatePlus;
                    SendG = mWSButtonStateMinus;
