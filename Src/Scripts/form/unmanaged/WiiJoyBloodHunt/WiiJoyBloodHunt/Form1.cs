    ...
    public partial class Form1 : Form
    {
        ...
        private static void taskX()
        {
            while (running)
            {
                ...
                if (stickLeft[1] > 0.35f)
                    leftsticky = 32767;
                if (stickLeft[1] < -0.35f)
                    leftsticky = -32767;
                if (stickLeft[1] <= 0.35f & stickLeft[1] >= -0.35f)
                    leftsticky = 0;
                if (stickLeft[0] > 0.35f)
                    leftstickx = 32767;
                if (stickLeft[0] < -0.35f)
                    leftstickx = -32767;
                if (stickLeft[0] <= 0.35f & stickLeft[0] >= -0.35f)
                    leftstickx = 0;
