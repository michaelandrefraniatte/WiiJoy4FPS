...
namespace WiiJoyPlay
{
    public partial class Form1 : Form
    {
        ...
        public static string KeyboardMouseDriverType = "kmevent";
        public static double MouseMoveX, MouseMoveY, MouseAbsX, MouseAbsY, MouseDesktopX, MouseDesktopY;
        public static int WidthS = System.Windows.Forms.Screen.PrimaryScreen.Bounds.Width / 2;
        public static int HeightS = System.Windows.Forms.Screen.PrimaryScreen.Bounds.Height / 2;
        ...
        private static void taskX()
        {
            while (running)
            {
                ...
                valchanged(0, LeftButtonCAPTURE & mWSButtonStateTwo);
                if (wd[0] == 1 & !Getstate)
                {
                    Getstate = true;
                ...
                if (Getstate)
                {
                    ...
                    Send6 = LeftButtonDPAD_UP;
                    Send7 = LeftButtonDPAD_LEFT;
                    Send8 = LeftButtonDPAD_DOWN;
                    Send9 = LeftButtonDPAD_RIGHT;
                    SendE = LeftButtonSR;
                    SendSpace = LeftButtonSHOULDER_1;
                    SendLeftShift = LeftButtonSHOULDER_2;
                    SendB = LeftButtonSTICK;
                    SendD = GetStickLeft()[0] > 0.25f;
                    SendQ = GetStickLeft()[0] < -0.25f;
                    SendZ = GetStickLeft()[1] > 0.25f;
                    SendS = GetStickLeft()[1] < -0.25f;
                    SendV = acc_gLeftY <= -1.13;
                    SendEscape = mWSButtonStateTwo;
                    SendH = LeftButtonCAPTURE;
                    ...
                    valchanged(1, mWSButtonStateMinus);
                    if (wd[1] == 1)
                    {
                        if (keys54321 == 0)
                            Send5 = true;
                    ...
                    valchanged(2, mWSButtonStatePlus);
                    if (wd[2] == 1)
                    {
                        if (keys12345 == 0)
                            Send1 = true;
                    ...
                    SendLeftClick = mWSButtonStateB | mWSButtonStateLeft | mWSButtonStateRight | LeftButtonMINUS | LeftButtonSL;
                    SendY = mWSButtonStateLeft;
                    SendU = mWSButtonStateRight;
                    Send0 = LeftButtonMINUS;
                    SendA = LeftButtonSL;
